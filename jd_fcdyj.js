...
let redEnvelopeId = 'b06d496714fd462b8edb33853ba828ff81111635167256100';
let inviter = 'eBPPf9QXV5C6zB0mDLiZ7j7n6TS8ifBavZq4en7Vu6c';
...
function helpme() {
    return new Promise(async (resolve) => {
                ...
                let options = {
    url: `https://api.m.jd.com/?functionId=openRedEnvelopeInteract&body={"linkId":"PFbUR7wtwUcQ860Sn8WRfw","redEnvelopeId":"${redEnvelopeId}","inviter":"${inviter}","helpType":"1"}&t=1626363029817&appid=activities_platform&clientVersion=1.0.0`,
